...
import 'package:indigo/modules/test-question/models/test-question-model.dart';
import 'test-question-page-content.dart';
import 'test-question-page.dart';
import 'package:video_player/video_player.dart';
import 'package:indigo/utils/HoverExtensions.dart';

class TestQuestionPageState extends State<TestQuestionPage> {

  final GlobalKey<ScaffoldState> scaffoldKey = GlobalKey<ScaffoldState>();
  final GlobalKey<FormState> formKey = GlobalKey<FormState>();
  bool reader = false;
  Color readerColor = Colors.black;
  TestQuestion register = new TestQuestion();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: TestQuestionPageContent(registerPageState: this),
    );
  }
}