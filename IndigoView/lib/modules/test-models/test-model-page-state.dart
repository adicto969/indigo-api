...
import 'package:indigo/modules/test-models/models/test-model-model.dart';
import 'package:indigo/utils/ValidatorText.dart';
import 'test-model-page-content.dart';
import 'test-model-page.dart';
import 'package:video_player/video_player.dart';
import 'package:indigo/utils/HoverExtensions.dart';

class TestModelPageState extends State<TestModelPage> {

  final GlobalKey<ScaffoldState> scaffoldKey = GlobalKey<ScaffoldState>();
  final GlobalKey<FormState> formKey = GlobalKey<FormState>();
  bool reader = false;
  Color readerColor = Colors.black;
  TestModel register = new TestModel();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: TestModelPageContent(registerPageState: this),
    );
  }
}